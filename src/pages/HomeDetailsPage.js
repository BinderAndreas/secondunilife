...
import { MdOutlineBed, MdOutlineBathtub, IoMdHeartEmpty, MdCheck } from 'react-icons/md';
  ...
  return (
    <div>
        ...
        <div className='property-pictures-container'>
            <img src={properties?.images[0]}/>
            <img src={properties?.images[1]}/>
            <img src={properties?.images[2]}/>
            <img src={properties?.images[3]}/>
        </div>
        ...
        <div className='features-container'>
          <div>
            <MdCheck />
            <p>{properties.key_features[0]}</p>
          </div>
          <div>
            <MdCheck />
            <p>{properties.key_features[1]}</p>
          </div>
          <div>
            <MdCheck />
            <p>{properties.key_features[2]}</p>
          </div>
          <div>
            <MdCheck />
            <p>{properties.key_features[3]}</p>
          </div>
          <div>
            <MdCheck />
            <p>{properties.key_features[4]}</p>
          </div>
        </div>
    </div>
  )
